...
import com.skydoves.githubfollows.room.*
...
class AppModule {
    ...
    @Provides
    @Singleton
    fun provideUserGitHubRepositoriesDao(database: AppDatabase): UserGitHubRepositoriesDao {
        return database.userGitHubRepositoriesDao()
    }
