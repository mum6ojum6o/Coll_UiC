...
public class MainAct extends Activity {
    ...
    private static int instC1;
    private static int instC2;
            ...
            switch (what) {
                ...
                case PLAYER2_MOVE:
                    ...
                    if (checkGameStatus()) {
                        ...
                        p2.getHandler().removeCallbacksAndMessages(null);
                        p1.getPlayer1Handler().removeCallbacksAndMessages(null);
                        Message msg1 = p2.getHandler().obtainMessage(STOP);
                        p2.getHandler().sendMessage(msg1);
                        Message msg2 = p1.getPlayer1Handler().obtainMessage(STOP);
                        p1.getPlayer1Handler().sendMessage(msg2);
